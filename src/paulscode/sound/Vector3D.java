...
public class Vector3D {
	 ...
	 * 
	 * @param nx
	 *            X coordinate for the new vector.
	 * @param ny
	 *            Y coordinate for the new vector.
	 * @param nz
	 *            Z coordinate for the new vector.
	 */
	...
	public Vector3D cross(Vector3D A, Vector3D B) {
		return new Vector3D(A.y * B.z - B.y * A.z, A.z * B.x - B.z * A.x, A.x
				* B.y - B.x * A.y);
	}
	...
	public Vector3D cross(Vector3D B) {
		return new Vector3D(y * B.z - B.y * z, z * B.x - B.z * x, x * B.y - B.x
				* y);
