...
public class SimpleThread extends Thread {
	 ...
	 * completed. NOTE: super.cleanup() must be called at the bottom of
	 * overriden cleanup() methods, and cleanup() must be called at the bottom
	 * of the run() method for all extended classes.
	 */
	...
	/**
	 * Returns false when the cleanup() method has finished. This method should
	 * be used to know when the thread has been safely shut down.
	 * 
