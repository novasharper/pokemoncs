...
public class ListenerData {
	...
	/**
	 * Constructor: Set this listener data to the specified values for position
	 * and orientation.
	 * 
	 * @param pX
	 ...
	 * @param a
	 *            Angle in radians that the listener is turned counterclockwise
	 *            around the y-axis.
	 */
	 ...
	 * @param l
	 *            Normalized vector indicating the direction which the listener
	 *            is facing.
	 * @param u
	 *            Normalized vector indicating the up direction.
	 * @param a
	 *            Angle in radians that the listener is turned counterclockwise
	 *            around the y-axis.
	 */
	...
	/**
	 * Change this listener data using the specified coordinates for position
	 * and orientation.
	 * 
	 * @param pX
	 *            Listener's X coordinate.
	 ...
	 *            Z element of the up direction.
	 */
	public void setOrientation(float lX, float lY, float lZ, float uX,
			float uY, float uZ) {
		lookAt.x = lX;
		lookAt.y = lY;
		lookAt.z = lZ;
	 ...
	 * 
	 * @param l
	 *            Normalized vector representing the look-at direction.
	 * @param u
	 *            Normalized vector representing the up direction.
	 */
	 ...
	 * 
	 * @param x
	 *            New velocity along world x-axis.
	 * @param y
	 *            New velocity along world y-axis.
	 * @param z
	 *            New velocity along world z-axis.
	 */
